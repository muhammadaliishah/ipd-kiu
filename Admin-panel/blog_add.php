...
$blog_image =  $_FILES['blog_image'];
 ...
 $filenamex =  $blog_image['name'];
$tmp_location = $blog_image['tmp_name'];
...
if(in_array($inputtype , $allowedtype)){
  echo "type matched";
  $distination  = 'blogimages/' .$filename;
  $distinationx  = 'ipd/blogimages/' .$filename;
  ...
  echo "uploaded to file ";  
       ...
       $query1 = " insert into blog( `b_title`  , `b_content` , `b_date` , `b_user`, `blog_image` )
        values('$title' , '$content', '$date' , '$id' , '$distination')";
