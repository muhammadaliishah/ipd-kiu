...
<div class="card-header">
   <a href="courses.php" class="text-primary">View All</a>
 ...
 $query = "SELECT * FROM `courses` where cid = '$postid'";
...
?>
 ...
 <h4 class="text-center"><?php echo $data['ctitle'] ?></h4> 
 
</p>
  <p class="card-text"><?php echo $data['cdetail'] ?> </p>
  <p class="card-text"> </p>
<hr>
  </div>
  <?php        }} }?>
