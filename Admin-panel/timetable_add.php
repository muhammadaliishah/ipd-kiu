...
<body id="page-top">
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
       ...
       $instructor =  $_POST['instructor'];
            ...
            $query2 = "INSERT INTO `timetable` (`t_coursename`, `t_start`, `t_end`,`t_location` , `instructor`) VALUES ('$coursename', '$start', '$end' , '$location' , '$instructor');";
...
<form action="timetable_add.php" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="time" name="end" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
     </div>
  <div class="mb-3">
