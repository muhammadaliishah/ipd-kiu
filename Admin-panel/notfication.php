...
<div class="card-header">
   <a href="notfication.php" class="text-primary">Notfications</a>||
...
if(isset($_GET['del'])){
    $id = $_GET['del'];
    $query3  = "DELETE FROM notfication WHERE nid=$id";
...
?>
  <div class="card-body">
  <p class="card-text"><?php echo $data['time'] ?>   
  
  <span class="text-center">
  <?php  if($_SESSION['role'] =='admin'){ ?>
    <a href="notfication.php?del=<?php echo $data['nid'] ?>"  >Delete Notficataion</a>
    <?php }?>
</span>
</p>
  <p class="card-text"><?php echo $data['ndescp'] ?> </p>
  <p class="card-text"> </p>
<hr>
  </div>
